...
func xtraFile(_ fileName: String, _ fileLines: [String]) -> [String] {
...
/*╭╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╮
  ...
  ╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╯*/
        ...
        let newLine = "\(columns[0])\t\(columns[1].padTo12()): \(getLookup(columns[1]))"
//      let newLine = "\(columns[0])\t\(columns[1])\t\(getLookup(columns[1]))"
...
fileprivate func getLookup(_ key: Substring) -> String {
    ...
    for (k, v) in lookup { if key.contains(k) { return v } }
...
//  "AGSBUF"        : "B15    FMT_SP    FormatEarthOrMoonSP TBD",
//  "AGSBUF"        : "B25    FMT_SP    FormatEarthOrMoonSP TBD",
//  "AGSBUFF"       : "B25    FMT_SP    FormatEarthOrMoonSP TBD",
    "AGSK"          : "B28    FMT_DP                        TBD",
    "AIG"           : "360    FMT_SP                        TBD",
    "AK"            : "180    FMT_SP                        TBD",
    "AK1"           : "180    FMT_SP                        TBD",
    ...
    "ALPHAQ"        : "90     FMT_SP                        TBD",
    "ALPHAR"        : "90     FMT_SP                        TBD",
    "ALT"           : "B29    FMT_DP                        TBD",
    "AMG"           : "360    FMT_SP                        TBD",
    "AOG"           : "360    FMT_SP                        TBD",
    ...
    "CDUS"          : "360    FMT_SP                        TBD",
//  "CDUT"          : "360    FMT_OCT                       TBD",
//  "CDUT"          : "B0     FMT_OCT                       TBD",
    "CDUX"          : "360    FMT_SP                        TBD",
    "CDUXD"         : "360    FMT_SP                        TBD",
    "CDUY"          : "360    FMT_SP                        TBD",
    "CDUYD"         : "360    FMT_SP                        TBD",
    "CDUZ"          : "360    FMT_SP                        TBD",
    "CDUZD"         : "360    FMT_SP                        TBD",
    "CENTANG"       : "360    FMT_DP                        TBD",
    "CHAN"          : "B0     FMT_OCT                       TBD",
    "CM EPOCH"      : "B18    FMT_DP    FormatEpoch         TBD",
    "CMDAPMOD"      : "B0     FMT_OCT                       TBD",
    "COMPNUMB"      : "B0     FMT_OCT                       TBD",
    "CSMMASS"       : "B16    FMT_SP                        TBD",
    "CSTEER"        : "4      FMT_SP                        TBD",
    "DAPBOOLS"      : "B0     FMT_OCT                       TBD",
    "DAPDATR1"      : "B0     FMT_OCT                       TBD",
    "DAPDATR2"      : "B0     FMT_OCT                       TBD",
...
//  "LASTYCMD"      : "B0     FMT_OCT                       TBD",
    ...
    "OGC"           : "360    FMT_DP                        TBD",
    "OMEGAP"        : "45     FMT_SP                        TBD",
    "OMEGAQ"        : "45     FMT_SP                        TBD",
    "OMEGAR"        : "45     FMT_SP                        TBD",
    "OMEGAPD"       : "45     FMT_SP                        TBD",
    "OMEGAQD"       : "45     FMT_SP                        TBD",
    "OMEGARD"       : "45     FMT_SP                        TBD",
...
//  "RSBBQ"         : "B0     FMT_2OCT                      TBD",
//  "RSBBQ"         : "B0     FMT_OCT                       TBD",
    "RTARG"         : "B29    FMT_DP                        TBD",
    "RTARGX"        : "B29    FMT_DP                        TBD",
    "RTARGY"        : "B29    FMT_DP                        TBD",
    "RTARGZ"        : "B29    FMT_DP                        TBD",
...
//  "SVMRKDAT+5"    : "45     FMT_SP    FormatOTRUNNION     TBD",
    ...
    "TGO"           : "B28    FMT_DP                        TBD",
    "THETAD"        : "360    FMT_SP                        TBD",
    "THETADX"       : "360    FMT_USP                       TBD",
    "THETADY"       : "360    FMT_USP                       TBD",
    "THETADZ"       : "360    FMT_USP                       TBD",
    "THETAH"        : "360    FMT_DP                        TBD",
    "TIG"           : "B28    FMT_DP                        TBD",
    "TIME"          : "B28    FMT_DP                        TBD",
